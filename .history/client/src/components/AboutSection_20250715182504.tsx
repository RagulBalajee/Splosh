          ...
          <div ref={contentRef} className="space-y-12">
            ...
            <div className="space-y-8">
              {features.map((feature, index) => (
                ...
                >
                  <div
                    className="flex-1 flex items-center bg-background/80 border border-border rounded-2xl px-6 py-5 shadow-md transition-all duration-300 group-hover:ring-4 group-hover:ring-[#23336a] group-hover:shadow-2xl group-hover:scale-105"
                  >
                    <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 bg-gradient-to-br from-primary via-fuchsia-400 to-cyan-400 animate-gradient-move transition-all duration-300 group-hover:shadow-lg group-hover:ring-4 group-hover:ring-[#23336a]">
                      <feature.icon className="w-7 h-7 text-white drop-shadow-lg group-hover:drop-shadow-[0_0_12px_#23336a] transition-all duration-300" />
                    </div>
                    <div className="ml-6">
