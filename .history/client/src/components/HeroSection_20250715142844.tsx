...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center card glass bg-card border-glass">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          >
            ...
            <Button onClick={() => naviagte("/login")} size="lg" className="min-w-[200px]">
              Explore Ecosystem
            </Button>
          </div>
        </div>
