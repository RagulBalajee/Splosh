...
export default function MyLevelBonus() {
      ...
      <Card className="rounded-2xl border border-border/50">
        <CardContent>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
            ...
            <span className="text-xl font-bold text-muted-foreground md:ml-4">Level Bonus</span>
          </div>
            ...
            <table className="min-w-full text-sm">
              ...
              <tbody>
                {filteredData.length === 0 ? (
                  <tr>
                    <td colSpan={8} className="text-center py-8 font-semibold text-muted-foreground">No Data Found.</td>
                  </tr>
                ) : (
